...
//
// NOTE: x and z are deliberately swapped below to correct for
// physical wiring on the PCB. Do not change. — Razeen '21
// ================================================================
...
void processPacket(uint8_t *buf) {
  ...
  // buf[6] reserved — GUI applies throttle scaling, we just drive

  if (x_i8 == 0 && z_i8 == 0) {
    stopAll();
    watchdogTripped = false;  // idle stop, not a fault
  } else {
