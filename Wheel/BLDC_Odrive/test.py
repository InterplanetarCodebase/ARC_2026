...
class HBMotorConfig:
    ...
    def configure(self) -> None:
        ...
        # Estimated KV but should be measured using the "drill test"
        ...
        # Reduce velocity tracking bandwidth for smoother estimates with low
        # resolution hall feedback.
        ...
        print("Calibrating motor (you should hear a beep)...")
        ...
        # --- Optional: Anticogging Calibration ---
        if self.anticogging_cal:
            print("Calibrating for anticogging...")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--motor_test",
        action="store_true",
        help="Test conducted at end of calibration to move motor in 30 deg increments.",
    )
    ...
    if args.motor_test:
        print("Placing motor in closed loop. If you move motor, motor will resist you.")
